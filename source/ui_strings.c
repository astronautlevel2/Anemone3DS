...
const Language_s language_english = {
    ...
    .remote =
    {
        ...
        .http_timeout = "HTTP Timeout.\nCheck your Wi-Fi signal and check\nyour proxy setting if set and try again.",
        .http_no_network = "Unable to connect to the Internet.\nCheck if the Wi-Fi is enabled and\ncheck your custom DNS if set and try again.",
        .http_ssl_error = "SSL Error - 0x%08lx.\nCheck if the date/time is correct, and that\nAnemone is up to date. If you're not using\nThemePlaza, the website might not work.",
...
const Language_s language_french = {
    ...
    .remote =
    {
        ...
        .http_timeout = "HTTP Timeout.\nVérifiez la réception du signal Wifi\net vos paramètres proxy puis réessayez.",
        .http_no_network = "Impossible de se connecter à Internet.\nVérifiez si le Wifi est activé et\nque vos paramètres DNS sont corrects\npuis réessayez.",
        .http_ssl_error = "SSL Error - 0x%08lx.\nVérifiez la date et l'heure et que\nAnemone est à jour. Si vous n'utilisez pas\nThemePlaza, le site, peut ne pas fonctionner.",
