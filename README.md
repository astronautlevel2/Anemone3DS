 ...
 * citro2d, zlib, jansson, libvorbisidec, and libarchive, which can be retrieved from [devkitPro pacman](https://devkitpro.org/viewtopic.php?f=13&t=8702).
...
To install the prerequisite libraries, begin by ensuring devkitPro pacman is installed, and then install the dkP packages `citro2d`, `3ds-zlib`, `3ds-jansson`, `3ds-libvorbisidec`, and `3ds-libarchive` using `[sudo] pacman -S <package-name>`.  
